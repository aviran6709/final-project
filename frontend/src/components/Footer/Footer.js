    ...
    return(
        <footer className="footer">
            ...
            < div className="footer__links">
               ...
               <a href="http://github.com" target="_blank"  rel="noopener noreferrer"><img  className="footer__links_btn" src={gitHub} alt="github icon" /></a>
               <a  href="http://facebook.com" target="_blank" rel="noopener noreferrer" > <img className="footer__links_btn" src={facebook} alt="facebook icon" ></img></a> 
              </div>
